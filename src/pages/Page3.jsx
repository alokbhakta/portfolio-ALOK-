...
function Page3({ scrollToSection }) {
  ...
  return (
    <div
      ref={pageRef}
      className="w-screen min-h-screen flex md:flex-row gap-4 overflow-hidden"
    >
        ...
        <div ref={edu} className="flex flex-col gap-5">
          ...
          <div className="flex flex-wrap gap-6">
            <div ref={addToEduRefs} className="w-full md:w-[32%]">
              <h2 className="font-[hiThere] text-lg">
                Delhi Technical Campus, GGSIPU (2021–2025)
              </h2>
              <p className="font-serif">B.Tech in CSE (GPA: 8.48/10)</p>
            </div>
            <div ref={addToEduRefs} className="w-full md:w-[32%]">
              <h2 className="font-[hiThere] text-lg">
                Plato Public School (2020–2021)
              </h2>
              <p className="font-serif">Class 12th (77%)</p>
            </div>
            <div ref={addToEduRefs} className="w-full md:w-[32%]">
              <h2 className="font-[hiThere] text-lg">
                Plato Public School (2018–2019)
              </h2>
              <p className="font-serif">Class 10th (80%)</p>
            </div>
          </div>

          <h1 ref={tech} className="font-[hiThere] text-xl md:text-3xl mt-8">
            TECHNICAL SKILLS
          </h1>
          <h2
            ref={techRef}
            className="font-semibold md:w-[500px] text-base md:text-xl tracking-wide"
          >
            C++, HTML, CSS, JavaScript, Sass, Tailwind, React.js, Gsap, Node.js,
            Express.js, REST APIs, WebSockets, JWT, Passport.js, MongoDB, Redis,
